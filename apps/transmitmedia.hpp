...
public:
    ...
    int Read(size_t chunk, bytevector& data, uint64_t& src_time, ostream& out_stats = cout) override;
...
public:
    ...
    int Write(const char* data, size_t size, uint64_t src_time, ostream &out_stats = cout) override;
    bool IsOpen() override { return IsUsable(); }
