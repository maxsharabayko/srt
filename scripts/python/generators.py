...
class FileCCLoopTestConfig:
    ...
    rtt: int = attr.ib()
    congctrl: typing.List[str] = attr.ib()
    time_to_stream: int = attr.ib()
...
def filecc_loop_test_generator(
    ...
    for cc in test_config.congctrl:
        # Calculate number of packets for time_to_stream sec of streaming
        ...
        description = f'{global_config.scenario}-alg-{global_config.algdescr}-msg_size-{test_config.msg_size}-cc-{cc}'
